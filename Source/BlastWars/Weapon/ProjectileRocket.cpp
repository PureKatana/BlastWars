...
void AProjectileRocket::BeginPlay()
{
	...
	GetWorldTimerManager().SetTimer(DestroyRocketTimer, this, &AProjectileRocket::DestroyTimerFinished, DestroyRocketTime);
}
...
void AProjectileRocket::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	...
	GetWorldTimerManager().SetTimer(DestroyOnHitTimer, this, &AProjectileRocket::DestroyTimerFinished, DestroyOnHitTime);
	if (ImpactParticles)
	{
